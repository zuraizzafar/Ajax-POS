                                            ...
                                            <div class="card-body col-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 text-center">
                                                        <button class="btn btn-success update-quantity" data-id="<?php echo $prod_id; ?>"> <i class="fas fa-check-circle"></i> </button>
                                                        <button class="btn btn-danger delete-item" data-id="<?php echo $prod_id; ?>"> <i class="fas fa-trash"></i> </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="card-body col-8">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4 text-center">
                                                            <button class="btn btn-danger delete-item" data-id="<?php echo $row['id']; ?>"> <i class="fas fa-trash"></i> </button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
